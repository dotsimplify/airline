...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-200">
      <div className="max-w-[2000px] px-8 py-12 mx-auto sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <img src="/logo.svg" className="mr-5 h-6 sm:h-9 w-1/2" alt="logo" />
            <p className="max-w-xs mt-4 text-sm text-gray-600">
              We are here to help you find best deals on flights & hotel booking
            </p>
            <div className="flex mt-8 space-x-6 text-gray-600">
              <a
                className="hover:underline cursor-pointer"
                href="/facebook.com/airlinesexperts"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <a
                className="hover:underline cursor-pointer"
                href="/instagram.com/airlinesexperts"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <a
                className="hover:underline cursor-pointer"
                href="/twitter.com/airlinesexperts"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <a
                className="hover:underline cursor-pointer"
                href="/linkedin.com/airlinesexperts"
                target="_blank"
                rel="noreferrer"
              >
                ...
                <svg
                  aria-hidden="true"
                  className="w-6 h-6 hover:text-sky-700"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
          ...
          <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div>
              ...
              <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                ...
                <a
                  className="hover:underline cursor-pointer"
                  href="tel:+18888651094"
                >
                  Helpline for Best Deals
                </a>
              </nav>
            </div>
            <div>
    ...
    // <footer className="p-4 mx-auto max-w-[2000px] border-t bg-sky-900  sm:p-6 dark:bg-gray-900 border-t-gray-300">
