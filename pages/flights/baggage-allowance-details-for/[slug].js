...
import BaggageAllowance from "../../../components/flights/partials/BaggageAllowance";
  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href={`https://airlinesexperts.com/flights/baggage-allowance-details-for/${props.airline.slug}`}
        />
        <meta
          name="keywords"
      ...
      <div className="relative px-4 py-4 bg-gray-50 lg:px-8">
        <BaggageAllowance airlineName={props.airline?.title?.rendered} />
      </div>
    </>
  );
};
