...
import NameChange from "../../../components/flights/partials/NameChange";
  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href={`https://airlinesexperts.com/flights/flight-ticket-name-change-fee/${props.airline.slug}`}
        />
        <meta
          name="keywords"
      ...
      <div className="relative px-4 py-4 lg:px-8 bg-gray-50 ">
        <NameChange airlineName={props.airline?.title?.rendered} />
      </div>
    </>
  );
};
