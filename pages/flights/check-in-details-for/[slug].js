...
import CheckIn from "../../../components/flights/partials/CheckIn";
  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href={`https://airlinesexperts.com/flights/check-in-details-for/${props.airline.slug}`}
        />
        <meta
          name="keywords"
      ...
      <div className="relative px-4 py-4 lg:px-8 bg-gray-50 ">
        <CheckIn airlineName={props.airline?.title?.rendered} />
      </div>
    </>
  );
};
