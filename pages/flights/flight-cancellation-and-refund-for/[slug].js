...
import Refunds from "../../../components/flights/partials/Refunds";
  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href={`https://airlinesexperts.com/flights/flight-cancellation-and-refund-for/${props.airline.slug}`}
        />
        <meta
          name="keywords"
      ...
      <div className="relative px-4 py-4 lg:px-8 bg-gray-50 ">
        <Refunds airlineName={props.airline?.title?.rendered} />
      </div>
    </>
  );
};
