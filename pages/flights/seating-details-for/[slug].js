...
import Seating from "../../../components/flights/partials/Seating";
  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href={`https://airlinesexperts.com/flights/seating-details-for/${props.airline.slug}`}
        />
        <meta
          name="keywords"
      ...
      <div className="relative px-4 py-4 lg:px-8 bg-gray-50 ">
        <Seating airlineName={props.airline?.title?.rendered} />
      </div>
    </>
  );
};
